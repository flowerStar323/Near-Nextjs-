      ...
      <div className="ggonearout" ref={myRef}>
        <Gonear>
          <GonearLeft>
            ...
            <GoBtns>
              <GoBtn>{loading ? <Loading /> : <Image src={CoinDeskLogo} objectFit="cover" layout="fill" />}</GoBtn>
              <GoBtn>{loading ? <Loading /> : <Image src={CoinLogo} objectFit="cover" layout="fill" />}</GoBtn>
            </GoBtns>
          </GonearLeft>
        </Gonear>
      </div>
