        ...
        <LearnMoreOut>
            <LearnMoreHeader>
                ...
                <LogoGroup>
                    <LogoLine>
                        <LogoTwo>
                            <LogoBtn>{loading ? <Loading /> : <BitcoinLogo />}</LogoBtn>
                            <LogoBtn>{loading ? <Loading /> : <Image src={Coin} layout='fill' objectFit='cover' />}</LogoBtn>
                        </LogoTwo>
                        <LogoTwo>
                            <LogoBtn>{loading ? <Loading /> : <Image src={CoinDesk} layout='fill' objectFit='cover' />}</LogoBtn>
                            <LogoBtn>{loading ? <Loading /> : <Image src={Yahoo} layout='fill' objectFit='cover' />}</LogoBtn>
                        </LogoTwo>
                    </LogoLine>
                    <LogoLine>
                        <LogoTwo>
                            <LogoBtn>{loading ? <Loading /> : <Image src={CoinDesk} layout='fill' objectFit='cover' />}</LogoBtn>
                            <LogoBtn>{loading ? <Loading /> : <Image src={Youtube} layout='fill' objectFit='cover' />}</LogoBtn>
                        </LogoTwo>
                        <LogoTwo>
                            <LogoBtn>{loading ? <Loading /> : <BitcoinLogo />}</LogoBtn>
