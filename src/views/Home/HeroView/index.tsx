      ...
      <div className="gonearOut" ref={myRef}>
        <GoNear>
          <GoNearLeft>
            ...
            <GoBtns>
              <GoBtn>
                {loading ? <Loading /> : <Image src={YahooLogo} blurDataURL="svg" layout="fill" />}
              </GoBtn>
              <GoBtn> {loading ? <Loading /> : <Image src={CoinLogo} blurDataURL="svg" objectFit="cover" layout="fill" />}</GoBtn>
              <GoBtn> {loading ? <Loading /> : <Image src={CoinDeskLogo} blurDataURL="svg" objectFit="cover" layout="fill" />}</GoBtn>
            </GoBtns>
          </GoNearLeft>
          <GoNearRight />
        </GoNear>
